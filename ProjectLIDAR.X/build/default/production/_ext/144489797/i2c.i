# 1 "E:/Projetos/project_LIDAR/ProjectLIDAR.X/i2c.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "E:/Projetos/project_LIDAR/ProjectLIDAR.X/i2c.c" 2
...
# 2 "E:/Projetos/project_LIDAR/ProjectLIDAR.X/i2c.c" 2
...
# 3 "E:/Projetos/project_LIDAR/ProjectLIDAR.X/i2c.c" 2



# 1 "E:/Projetos/project_LIDAR/ProjectLIDAR.X/i2c.h" 1
# 82 "E:/Projetos/project_LIDAR/ProjectLIDAR.X/i2c.h"
void I2C_Master_Init(const unsigned long);
# 91 "E:/Projetos/project_LIDAR/ProjectLIDAR.X/i2c.h"
...
# 6 "E:/Projetos/project_LIDAR/ProjectLIDAR.X/i2c.c" 2
# 21 "E:/Projetos/project_LIDAR/ProjectLIDAR.X/i2c.c"
void I2C_Master_Init(const unsigned long clockspeed)
{
  SSPCON = 0b00101000;
  SSPCON2 = 0;
  SSPADD = (8000000/(4*clockspeed))-1;
  SSPSTAT = 0;
  TRISC0 = 1;
  TRISC1 = 1;
}
# 38 "E:/Projetos/project_LIDAR/ProjectLIDAR.X/i2c.c"
void I2C_Master_CallSlave(unsigned char address, char rw)
{
    I2C_Master_Write(address + rw);
}
...
{
    I2C_Master_CallSlavePlus(address, 0);
...
{
    I2C_Master_WriteComplete(address, 0, 1);

    I2C_Master_CallSlavePlus(address, 1);
